...
A = -Mundo; A = A+255; %Mostrar(uint8(A),'aaa')
...
outputFileName = 'testAlpha7.png';

% Save the image with alpha channel as a PNG file
imwrite(Fire, outputFileName, 'png', 'Alpha', A_aux/255);
